...
class dungeon_UI {
private:
   static dungeon_UI *dui;
   dungeon_UI() { };
   dungeon_UI(const dungeon_UI &x) { };
   dungeon_UI &operator=(const dungeon_UI &) { return *dui; };
public:
  static dungeon_t *the_dungeon;
  static dungeon_UI *instance();
  static char *dungeon_text();
  static void set_dungeon(dungeon_t *d);
  static dungeon_t *get_dungeon();
  static void gen_character_map();
};
...
typedef struct dungeon {
  ...
  char character_map[DUNGEON_Y][DUNGEON_X];
